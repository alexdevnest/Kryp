// This functionality is only available for CoinGecko pro users only!!.
'use client';
...
export const useCoinGeckoWebSocket = ({
  ...
  useEffect(() => {
    ...
    const send = (payload: Record<string, unknown>) => ws.send(
  ...
  useEffect(() => {
    ...
    const poolAddress = poolId.replace('-', ':')
